...
<body>
  ...
  <main id="main"><!-- #testimonials -->
    <!--==========================
      Contact Section
    ============================-->
    <section id="contact" class="contact1 section-bg wow fadeInUp">
      <div class="container">

        <div class="section-header">
          <h3>Contactez-Nous</h3>
          <p>Merci de nous laisser un message, une remarque, un encouragement ou notification pour nous permettre d'amelioler nos services</p>
        </div>
